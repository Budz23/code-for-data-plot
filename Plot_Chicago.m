...
% Data Source: Chicago Area Weather Station

% 1. READING AND PROCESSING DATA
try
    % Reading CSV file into a table
    data = readtable('DATACHICAGOBULANAN.csv');
catch
    error('DATACHICAGOBULANAN.csv file not found in the current directory.');
end
...
figure('Name', 'Monthly Time Series and Spectrum Analysis - Chicago Area');
...
sgtitle('Monthly Data Time Series and Spectrum Analysis for Chicago Area');